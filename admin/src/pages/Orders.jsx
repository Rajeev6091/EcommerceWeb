...
function Orders() {
  ...
  return (
    <div className='w-[99vw] min-h-[100vh] bg-gradient-to-br from-[#0f2027] via-[#203a43] to-[#2c5364] text-[white]'>
      <Nav/>
          ...
          gap-[30px] overflow-x-hidden py-[50px] ml-[100px]'>
             ...
             </div>
             {
               orders.map((order, index)=>(
                <div key={index} className='w-[90%] h-[40%] bg-slate-600 rounded-xl flex lg:items-center items-start 
                justify-between flex-col lg:flex-row p-[10px] md:px-[20px] gap-[20px]'>
